...
DECLSPEC_IMPORT     WINBASEAPI size_t __cdecl MSVCRT$MSVCRT$strlen(const char *_Str);
...
DECLSPEC_IMPORT BOOL ADVAPI32$OpenThreadToken(
	HANDLE  ThreadHandle,
	DWORD   DesiredAccess,
	BOOL    OpenAsSelf,
	PHANDLE TokenHandle
);
DECLSPEC_IMPORT SECURITY_STATUS SEC_ENTRY SECUR32$AcquireCredentialsHandleA(
...
DECLSPEC_IMPORT KSECDDDECLSPEC SECURITY_STATUS SEC_ENTRY SECUR32$FreeCredentialsHandle(
    PCredHandle phCredential
);
DECLSPEC_IMPORT KSECDDDECLSPEC SECURITY_STATUS SEC_ENTRY SECUR32$QuerySecurityContextToken(
    PCtxtHandle phContext,
    void        **Token
);
DECLSPEC_IMPORT KSECDDDECLSPEC SECURITY_STATUS SEC_ENTRY SECUR32$DeleteSecurityContext(
  PCtxtHandle phContext
);

DECLSPEC_IMPORT SECURITY_STATUS SEC_ENTRY SECUR32$InitializeSecurityContextA(
	PCredHandle    phCredential,
	PCtxtHandle    phContext,
...
DECLSPEC_IMPORT KSECDDDECLSPEC SECURITY_STATUS SEC_ENTRY SECUR32$AcceptSecurityContext(
	PCredHandle    phCredential,
	PCtxtHandle    phContext,
	PSecBufferDesc pInput,
	unsigned long  fContextReq,
...
/* DECLSPEC_IMPORT BOOL ADVAPI32$LookupPrivilegeNameA( */
/* 	LPCSTR  lpSystemName, */
/* 	PLUID   lpLuid, */
/* 	LPSTR   lpName, */
/* 	LPDWORD cchName */
